...
- `TerminalEngineModule`: Virtualized scrollback buffer rendering prompt (`C:\Users\ReOS> `), raw keystroke capture, interactive `stdin` SharedArrayBuffer atomics, and Smart Error Navigation link parsing.
